<x-app-layout>
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{url('css/assign1.css')}}" media="screen" />
    <script class="u-script" type="text/javascript" src="{{url('/js/jquery1.js')}}" defer=""></script>
  ...
  <body class="u-body u-xl-mode">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-01c0">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <a href="{{url('assign2')}}" data-page-id="836106269"
          class="u-border-none u-btn u-button-style u-custom-color-2 u-hover-palette-5-dark-3 u-btn-1">NEXT</a>
      </div>
    </section>
