                    ...
                    <div class="u-container-layout u-container-layout-1">
                        <h2 class="u-align-left u-text u-text-3">
                            <span style="font-size: 1.875rem"><b></b><b>&nbsp;D-&nbsp;&nbsp; </b>
                                <!--[endif]--><b> General and Transfer​able Skills:
                                </b>&nbsp;&nbsp;
                            </span>
                            <br />
                            ...
                            <form name="ilos1" action="http://127.0.0.1:8000/specs2/updatedgts" method="POST"
                                class="u-align-left u-text u-text-4 u-text-default ">
                                <div class="u-form u-form-1">
                                    @php
                                    $data = DB::table('constant_ilos')->where('type','gts')->get();
