<x-app-layout>
    ...
    <script class="u-script" type="text/javascript" src="https://qualitymiu.ukshopy.com/publicjs/jquery2.js" defer="">
    </script>
    <script class="u-script" type="text/javascript" src="https://qualitymiu.ukshopy.com/public/js/nicepage2.js"
        defer=""></script>
    ...
    <body class="u-body u-xl-mode">
        ...
        <section class="u-border-15 u-border-grey-75 u-clearfix u-section-1" id="sec-5e2c">
            ...
            <form method="POST" action="http://127.0.0.1:8000/specs7/insertformindatabase">
                @csrf
                <!-- {{ csrf_field() }} -->
