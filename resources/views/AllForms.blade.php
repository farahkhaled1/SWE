        ...
        <div class="u-repeater u-repeater-1">
          ...
          <div class="u-align-center u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2"><span
                class="u-file-icon u-icon u-icon-circle u-white u-icon-2"><img src="{{url('images/form2.png')}}"
                  alt=""></span>
          ...
          <div class="u-align-center u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3"><span
                class="u-file-icon u-icon u-icon-circle u-white u-icon-3"><img src="{{url('images/form3.png')}}"
                  alt=""></span>
              <p class="u-align-center u-text u-text-custom-color-1 u-text-default u-text-5">Course Specification Form
              </p>
              <a href="{{url('specs1')}}"
