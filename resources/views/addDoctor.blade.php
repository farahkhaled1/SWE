...
<body class="u-body u-xl-mode">
  <header class="u-clearfix u-gradient u-header u-header" id="sec-8e70">
  ...
  <section
    class="u-border-5 u-border-custom-color-2 u-border-no-left u-border-no-right u-border-no-top u-clearfix u-custom-color-4 u-valign-bottom u-section-1"
    id="sec-c1b6">
  ...
  <section class="u-clearfix u-gradient u-section-2" id="sec-d12f">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-border-6 u-border-palette-1-dark-2 u-expanded-width u-shape u-shape-rectangle u-shape-1"></div>


      <h5 class="u-text u-text-2">Course Name :&nbsp; <div class="form-outline">
          <textarea class="form-control" id="coursenametextarea" rows="1"></textarea>
        </div>
        <span style="font-weight: 700;"></span>
      </h5>

      <h5 class="u-text u-text-3">Name :&nbsp; <div class="form-outline">
          <textarea class="form-control" id="coursenametextarea" rows="1"></textarea>
        </div>
        <span style="font-weight: 700;"></span>
      </h5>

      <h5 class="u-text u-text-5">Course ID :&nbsp;<div class="form-outline">
          <textarea class="form-control" id="courseidtextarea" rows="1"></textarea>
        </div>
        <span style="font-weight: 700;"></span>
      </h5>

      <h5 class="u-text u-text-6">Email :&nbsp;
        <div class="form-outline">
          <textarea class="form-control" id="emailtextarea" rows="1"></textarea>
          <span style="font-weight: 700;">
          </span>
      </h5>

      <h5 class="u-text u-text-4">ID :&nbsp; <div class="form-outline">
          <textarea class="form-control" id="idtextarea" rows="1"></textarea>
          <span style="font-weight: 700;">
      </h5>
