...
<body class="u-body u-xl-mode">
  ...
  <section class="u-border-15 u-border-grey-75 u-clearfix u-section-1" id="sec-2845">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-form u-form-1">
        <form action="#" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="custom"
          ...
          <div class="u-form-group u-form-textarea u-form-group-1">
            ...
            <input type="checkbox" name="ilos[]" value="test"> Image processing programs. <br />
      ...
      <a href="specs_Student-assessment.html"
        class="u-border-none u-btn u-button-style u-grey-75 u-hover-grey-90 u-btn-2">NEXT</a>
    </div>
  </section>
